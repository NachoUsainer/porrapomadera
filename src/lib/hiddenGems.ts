...
export const GEMS: Gem[] = [
  ...
  { text: "Si se cae el Estadio Azteca, lo ha construido Sisco", names: ["sisco", "sicanovich", "cisco", "francisco"] },
  ...
  { text: "Alvarín, alvarín: alvarín te quiero", names: ["alvarin", "alvaro", "alvarito", "alvar"] },
